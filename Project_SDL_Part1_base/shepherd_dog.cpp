...
shepherd_dog::shepherd_dog(const std::string& file_path, SDL_Surface* window_surface_ptr, shepherd* player) :
    player_{player},
...
void shepherd_dog::interact(animal* otherAnimal,ground& ground, std::vector<std::shared_ptr<animal>>& new_shepherd_dogs) {
