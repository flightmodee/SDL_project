...
shepherd::shepherd(const std::string& file_path, SDL_Surface* window_surface_ptr,ground& ground_ptr) :

    playable_character(file_path, window_surface_ptr, ground_ptr) {
...
void shepherd::interact(std::shared_ptr<moving_object> otherAnimal) {}
